...
<header class="d-flex">
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark box-shadow flex-grow-1">
        <div class="container d-flex justify-content-between">
            <a href="/" class="navbar-brand d-flex align-items-center gap-3">
                ...
                <strong>Surf Shop by Nico</strong>
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="/profile">Mes commandes</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#" onclick="document.getElementById('logoutForm').submit(); return false;">Déconnexion</a>
...
<main role="main" class="flex-grow-1 d-flex flex-column overflow-y-auto">
    <section class="jumbotron text-center flex-grow-1 d-flex flex-column justify-content-between">
        <img src="/images/img403.gif" alt="404" style="height: 50vh;margin: auto"/>
        <h1 class="display-4" style="color: #4e4e50">Va passer ta certification d’Administrateur, puis reviens.</h1>
        <p class="lead">
