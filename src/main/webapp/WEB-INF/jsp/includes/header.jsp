...
<header class="d-flex">
    ...
    <security:authorize access="isAuthenticated()">
        <p class="bg-dark m-0 d-flex align-items-center justify-content-center" style="padding-right: 20px;">
            Utilisateur : <security:authentication property="principal.identifiant" />
        </p>
    </security:authorize>
